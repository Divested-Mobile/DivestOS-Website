...
echo 5 > instantnoodle/status-20.0;
echo 8 > instantnoodlep/status-19.1;
echo 5 > instantnoodlep/status-20.0;
echo 8 > kebab/status-19.1;
echo 5 > kebab/status-20.0;
...
echo 5 > guacamole/status-20.0;
echo 7 > guacamoleb/status-19.1;
echo 5 > guacamoleb/status-20.0;
...
echo 5 > hotdog/status-20.0;
echo 7 > hotdogb/status-19.1;
echo 5 > hotdogb/status-20.0;
