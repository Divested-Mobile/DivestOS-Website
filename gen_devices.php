				...
				if(sizeof($files) > 5) {
					...
					if(strlen($zip) > 30) {
						...
						if(file_exists($realRootdir . $device . "/" .$zip . ".sha512sum")) {
							$resultHashOTA = "/builds/" . $base . "/" . $device . "/" . $zip . ".sha512sum";
						}
						...
						if(strlen($recovery) > 36 && file_exists($recoveryPath)) {
							...
							if(file_exists($recoveryPath . ".sha512sum")) {
								$resultHashRecovery = "/builds/" . $base . "/" . $device . "/" . $recovery . ".sha512sum";
							}
						}
						...
						if(strlen($fastboot) > 36 && file_exists($fastbootPath)) {
							...
							if(file_exists($fastbootPath . ".sha512sum")) {
								$resultHashFastboot = "/builds/" . $base . "/" . $device . "/" . $fastboot . ".sha512sum";
							}
						}
						...
						if(file_exists($avbKeyPath)) {
							$resultKeyAVB = "/builds/" . $base . "/" . $device . "/" . $avbKey;
						}
						...
						if(file_exists($copyPartsPath)) {
							$resultCopyParts = "/builds/" . $base . "/" . $device . "/" . $copyParts;
						}
