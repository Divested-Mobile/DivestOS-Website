...
$SBNR_CACHABLE_PAGES = array("bootloader", "broken", "browsers", "build", "bug_reporting", "community", "faq", "functionality_tables", "history", "home", "messengers", "network_connections", "news", "news-future", "news-template", "our_apps", "patch_counts", "patch_levels", "post_install", "privacy_policy", "recommended_apps", "recommended_apps_md", "saving_data", "screenshots", "screenshots_dark", "technical_details", "terms_of_service", "troubleshooting", "verified_boot_hashes");
