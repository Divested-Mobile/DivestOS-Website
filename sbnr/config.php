...
$SBNR_CACHABLE_PAGES = array("bootloader", "broken", "browsers", "build", "faq", "history", "home", "messengers", "network_connections", "news", "news-future", "our_apps", "patch_levels", "post_install", "privacy_policy", "recommended_apps", "saving_data", "screenshots", "technical_details", "terms_of_service", "troubleshooting");
